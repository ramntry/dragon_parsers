...
bool ParserAction::push(std::stack<int> &symbolStack, int symbol1, int symbol2, int symbol3, int symbol4)
{
    push(symbolStack, symbol4);
    return push(symbolStack, symbol1, symbol2, symbol3);
}
